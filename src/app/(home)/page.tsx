  ...
  return (
    <main className="flex justify-center items-center w-full max-w-screen overflow-hidden">
      <section className="container lg:pl-context-padding p-5 flex flex-col-reverse lg:flex-row">
        <section className=" w-full lg:w-hero-content lg:mt-14 z-10">
          <div className="w-full mb-4">
            ...
            <h2 className=" self-stretch text-shadow-hero  font-bold text-aqua text-2xl lg:text-hero-size tracking-[0] leading-tight lg:leading-[normal] text-center lg:text-left">
          ...
          <ul className="flex flex-col items-center gap-3 md:gap-3.5 relative self-stretch w-full ">
            {features.map((feature, index) => (
              <li
                key={index}
                className="flex items-center gap-2.5 self-stretch w-full mt-1"
              >
                <span className=" w-fit font-nunito font-medium text-white text-lg md:text-top-bar-size text-center tracking-[0] leading-[normal] whitespace-nowrap flex-shrink-0">
                  ✨
                </span>
          ...
          <div className="mt-6 md:mt-8 flex flex-col-reverse md:flex-col  items-start md:gap-4 self-stretch w-full ">
            <div className="flex flex-col w-full lg:w-[313px] items-start gap-2.5 ">
              <Button className="flex items-center justify-center gap-2.5 px-8 lg:px-10 py-3 lg:py-2  self-stretch w-full  bg-top-bar-red rounded-[10px] shadow-[2px_2px_10px_#00e7f9] hover:bg-[#e0004a] ">
